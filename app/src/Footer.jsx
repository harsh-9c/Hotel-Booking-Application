export default function Footer() {
  return (
    // <footer class="mt-8 p-4 bg-gray-100 rounded-lg shadow md:px-6 md:py-8">
    //   <div class="sm:flex sm:items-center sm:justify-between">
    //     <a
    //       href="https://flowbite.com/"
    //       class="flex items-center mb-4 sm:mb-0 gap-1"
    //     >
    //       <svg
    ...
    <footer class="mt-8 p-4 bg-gray-100 rounded-2xl shadow shadow-black md:px-6 md:py-8">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-black-900">
          © 2023{" "}
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a
            href="#"
            class="text-black-500 hover:text-gray-900 dark:hover:text-primary"
          >
            <svg
              class="w-5 h-5"
              fill="currentColor"
